                ...
                res.render('transaction_history', {detail: array, 'current_page': 1, 'pages': 0, 'next': 1, 'pre': 0, moment: moment});
                   ...
                   var is_public_demo = setting_detail.is_public_demo;
                    ...
                    Transfer_History.aggregate([lookup1,lookup2
                        ...
                        res.render('transaction_history', {is_public_demo: is_public_demo, timezone_for_display_date: settingData.timezone_for_display_date, detail: array, 'current_page': page, 'pages': pages, 'next': next, 'pre': pre, moment: moment});
                        delete message;
                    }, (err) => {
