...
exports.list = function (req, res, next) {
    ...
    if (typeof req.session.userid != 'undefined') {
        ...
        Trip.aggregate([condition, trip_condition, payment_condition, status_condition, lookup, unwind, lookup1, lookup2, unwind2, lookup3, unwind3, search, filter, count]).then((array) => { 
            ...
            } else
            {
                ...
                Trip.aggregate([condition, trip_condition, payment_condition, status_condition, lookup, unwind, lookup1, lookup2, unwind2, lookup3, unwind3, search, filter, sort, skip, limit]).then((array) => { 
