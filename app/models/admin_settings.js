...
module.exports = mongoose.model('Settings', new Schema({
    ...
    josmsservice_acc_name: {type: String, default: ""},
    josmsservice_acc_password: {type: String, default: ""},
    josmsservice_sender_id: {type: String, default: ""},
    ...
    request_send_to_no_of_providers: {type: Number, default: 1},
