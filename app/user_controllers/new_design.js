...
exports.get_fare_estimate_all_type = function (req, res, next){
    ...
    console.log(currentCityLatLong);
    City.find({ isBusiness: constant_json.YES }).then((cityList) => {
        ...
        if (size == 0) {
            ...
            cityList.forEach(function (city_detail) {
                ...
                var csymbol = 0;
                console.log(cityList[0].countryid);
                Country.find({ _id: cityList[0].countryid }).then((Country1) => {
                    console.log(Country1)
                    csymbol = Country1[0].currencysign;
                    console.log(csymbol);
                });
